...
import rajsthan from "../Images/rajsthan.jpeg";
      ...
      <Box sx={{ flexGrow: 1, margin: 7 }}>
        <Grid container columnSpacing={{ md: 15, lg: 15 }}>
          ...
          <Grid item xs={12} md={6} lg={6}>
            ...
            <Typography variant="body2" color="#000" sx={{ marginLeft: 1.5 }}>
              {active.description}
            </Typography>
          </Grid>
        </Grid>
      ...
      <Box sx={{ flexGrow: 1, margin: 7 }}>
        <Box sx={{ display: "flex", flexGrow: 1, justifyContent: "center" }}>
          <Grid container sx={{ justifyContent: "center", marginLeft: -5 }}>
            ...
            <Grid item sx={{ marginRight: 1 }}>
              <Box
                ...
                style={
                  active !== images[0] ? { filter: "grayscale(100%)" } : null
                }
              />
            </Grid>
            <Grid item sx={{ marginRight: 1 }}>
              <Box
                ...
                style={
                  active !== images[1] ? { filter: "grayscale(100%)" } : null
                }
              />
            </Grid>
            <Grid item>
              <Box
                ...
                style={
                  active !== images[2] ? { filter: "grayscale(100%)" } : null
                }
              />
            </Grid>
          ...
          <Grid container sx={{ justifyContent: "center" }}>
            <Grid item>
              <PlayCircleIcon
                sx={{ fontSize: 80, marginTop: 1, color: "#AD1457" }}
              />
            </Grid>
          </Grid>
        </Box>
